...
DEFAULT_USER_BASE_DIR = Path.home() / "MetaAdsExport"
DEFAULT_USER_RAW_DIR = DEFAULT_USER_BASE_DIR / "raw"
DEFAULT_USER_TRACE_DIR = DEFAULT_USER_BASE_DIR / "trace"
DEFAULT_USER_OUTPUT_DIR = DEFAULT_USER_BASE_DIR / "output"
DEFAULT_USER_DOWNLOADS_DIR = DEFAULT_USER_RAW_DIR
DEFAULT_USER_LOGS_DIR = DEFAULT_USER_TRACE_DIR
